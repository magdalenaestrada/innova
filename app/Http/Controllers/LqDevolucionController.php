...
class LqDevolucionController extends Controller
{
    ...
    public function destroy(string $id)
    {
        try {
            ...
            foreach($devolucion->adelantos as $adelanto){
            ...
            $devolucion->delete();
            $devolucion->ingresocuenta->delete();


            DB::commit();
            return redirect()->route('lqdevoluciones.index')->with('status', 'Devolución eliminada con éxito.');
        } catch (QueryException $e) {
            DB::rollBack();
