    ...
    public function edit(string $id)
{
    ...
    $adelantos = LqAdelanto::with('salidacuenta.cuenta.tipomoneda')->get();

    $liquidacion = LqLiquidacion::with([
        'cliente',
        'sociedad.adelantos.salidacuenta.cuenta.tipomoneda',
        'sociedad.adelantos.liquidacion',
        'creador',
        'salidacuenta.cuenta.tipomoneda',
        'salidacuenta.motivo',
        'salidacuenta.tipocomprobante',
        'adelantos.sociedad',
        'adelantos.salidacuenta.cuenta.tipomoneda',
        'adelantos.salidacuenta.motivo',
        'adelantos.salidacuenta.tipocomprobante',
        'adelantos.creador'
    ])->findOrFail($id);

    // Prepare a merged data object for React
    $liquidacionData = [
    ...
    return view('tesoreria.liquidaciones.edit', compact('liquidacionData'));
}
    ...
    public function update(Request $request, string $id)
    {
        try {
            $request->validate([
                ...
                'tipocambio' => 'required',
                'conversion' => 'required',
                'descuentoadeldol' => 'nullable',
                'descuentoadelsol' => 'nullable',
                'importefinaldol' => 'nullable',
                'importefinalsol' => 'nullable',
                'otrosdescdol' => 'nullable',
                'otrosdescsol' => 'nullable',
