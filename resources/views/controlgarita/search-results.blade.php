@if (count($detalleSearch) > 0)
    @foreach ($detalleSearch as $detalle)
        <tr>

            <td scope="row">
                {{ strtoupper($detalle->id) }}
            </td>

            <td scope="row">
                @if ($detalle->tipo_documento == 1)
                    DNI
                @else
                    RUC
                @endif
            ...
            <td class="btn-group align-items-center">
                <a href="#" data-toggle="modal" data-target="#ModalEdit{{ $detalle->id }}" class="ml-1">
                ...
                <button class="btn btn-sm btn-danger btn-eliminar-cliente"
                    data-url="{{ route('clientescodigo.destroy', $detalle->id) }}">
            ...
            <a href="#" data-toggle="modal"
                data-target="#ModalEdit{{ $detalle->id }}" class="ml-1">
            ...
            <div class="align-items-center">
                <a class="btn btn-sm btn-secondary" href="#" data-toggle="modal"
                    data-target="#ModalShow{{ $codigo->id }}">
                    {{ __('VER') }}
                </a>
            </div>
            ...
            <a href="#" data-toggle="modal"
                data-target="#ModalEdit{{ $codigo->id }}" class="ml-1">
