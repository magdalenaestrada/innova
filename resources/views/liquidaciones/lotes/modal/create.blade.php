                ...
                <form class="crear-empleado" action="{{ route('lqlotes.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="form mb-1 col-md-4">
                            <input name="codigo" id="codigo" class=" form-control" placeholder="Código del lote..."
                                required="" type="text">
                        ...
                        <div class="form col-md-8">
                            <input name="nombre" id="nombre" class=" form-control"
                                placeholder="Ingrese el nombre del lote" required="" type="text">
                            <span class="-border"></span>
                        </div>
                        ...
                        <table class="table table-responsive">
                            ...
                            <tbody id="table_body">
                                <tr>
                                    ...
                                    <td>
                                        <select name="clientes[]" class="form-control buscador cart-product"
                                            style="width: 400px">
