...
<body>
    <div class="container pt-2">
        ...
        <div style="margin-top: -1.5%;" class="d-flex justify-content-between align-items-center">
            ...
            <h5 class="fs-6"><strong>DEVOLUCIÓN:</strong> IN-{{ $devolucion->id }}</h5>
        ...
        <div class="mt-5 d-flex justify-content-between align-items-center">
            ...
            <div>
                <p style="font-size: 12px">Nasca, {{ $devolucion->fecha->day }} de
                    {{ \Illuminate\Support\Str::ucfirst($devolucion->fecha->translatedFormat('F')) }} del
                    {{ $devolucion->fecha->year }}
                </p>
            </div>
        </div>
        ...
        <div class="mt-5 d-flex justify-content-between align-items-center" >
            ...
            <div>
                <p style="font-size: 12px">Nasca, {{ $devolucion->ingresocuenta->fecha->day }} de {{ \Illuminate\Support\Str::ucfirst($devolucion->ingresocuenta->fecha->translatedFormat('F')) }} del {{ $devolucion->ingresocuenta->fecha->year }}
                </p>
            </div>
        </div>
