...
<body>
    <div class="container pt-2">
        ...
        <div style="margin-top: -1.5%;" class="d-flex justify-content-between align-items-center">
            ...
            <h5 class="fs-6"><strong>RECIBO:</strong> IN-{{ $salidacuenta->id }}</h5>
        ...
        <div class="mt-5 d-flex justify-content-between align-items-center" >
            ...
            <div>
                <p style="font-size: 12px">Nasca, {{ $salidacuenta->fecha->day }} de {{ \Illuminate\Support\Str::ucfirst($salidacuenta->fecha->translatedFormat('F')) }} del {{ $salidacuenta->fecha->year }}
                </p>
            </div>
        </div>
